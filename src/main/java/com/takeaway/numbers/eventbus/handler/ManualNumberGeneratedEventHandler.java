...
public class ManualNumberGeneratedEventHandler extends Handler<NumberGeneratedEvent> {
    public ManualNumberGeneratedEventHandler(ApplicationCache applicationCache, Producer producer,
